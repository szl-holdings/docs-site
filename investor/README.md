# SZL Holdings — Investor Public Summary
...
Public-safe Series A materials for SZL Holdings. **No financials.** Confidential
financial model and cap table are shared directly with qualified investors on request.

**Honesty note:** SZL Holdings is pre-revenue with zero paying customers as of this
publication. Revenue figures elsewhere are forward projections only.

## Contents
- [Executive Summary](EXECUTIVE_SUMMARY_VC.md)
- [Competitive Landscape](COMPETITIVE_LANDSCAPE.md)
- [Market Sizing (TAM/SAM/SOM)](MARKET_SIZING_TAM_SAM_SOM.md)
